...
public class json {
    ...
    public JsonObject readJson() throws FileNotFoundException {

        JsonReader reader = new JsonReader(new FileReader(this.address));
...
//    public String showJson(String address){
//        String data = "";
//        
//        LinkedList<EntitySet> a = getEntitySets(address);
...
//        data += "\n\n----------------\n\n";
//        
//        LinkedList<RelationshipSets> b = getRelationshipSets(address);
